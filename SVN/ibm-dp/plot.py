...
def main():
    ...
    plot(x_axis, y_axis_perf, 'Performance - ibm-dp', 'Number of threads', 'Number of games simulated', techs)
    plot(x_axis, y_axis_scal, 'Scalability (weak scaling) - ibm-dp', 'Number of threads', 'Speedup', techs)
    plot(x_axis, y_axis_eff, 'Efficiency - ibm-dp', 'Number of threads', 'Efficiency', techs)
